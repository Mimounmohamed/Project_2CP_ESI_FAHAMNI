...
class _PersonalInfoScreenState extends State<PersonalInfoScreen> {
  ...
  Future<void> _loadUserData() async {
    ...
    try {
      ...
      setState(() {
        ...
        _selectedCity = _wilayaBaladiyat.containsKey(parsedCity)
            ? parsedCity
            : null;
  ...
  ImageProvider _resolveAvatar() {
    ...
    switch (_role) {
      ...
      case UserRole.tutor:
        return _gender == Gender.female
            ? const AssetImage("assets/images/tutorfemale.png")
            : const AssetImage("assets/images/tutormale.png");
      case UserRole.student:
        return _gender == Gender.female
