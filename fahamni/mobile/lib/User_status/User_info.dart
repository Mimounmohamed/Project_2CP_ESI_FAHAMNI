        ...
        child: ElevatedButton(
          onPressed: () {
            ...
            if (selectedIndex == 0) {
              ...
              data['academicDescription'] =
                  '${t.degreeController.text.trim()} — ${t.universityController.text.trim()}';
              data['yearsOfExperience'] =
                  int.tryParse(t.expController.text.trim()) ?? 0;
              data['pedagogicalDescription'] = t.bioController.text.trim();
              data['certified'] =
                  (t.fileKey.currentState?.uploadedFiles.isNotEmpty) ?? false;
              data['certificationFiles'] =
                  t.fileKey.currentState?.uploadedFiles ?? <PlatformFile>[];
      ...
      children: [
        Row(
          ...
          children: [
            ElevatedButton(
              onPressed: () =>
                  setState(() => selectedIndex = selectedIndex == 1 ? -1 : 1),
              style: ElevatedButton.styleFrom(
                elevation: 0,
            ...
            ElevatedButton(
              onPressed: () =>
                  setState(() => selectedIndex = selectedIndex == 2 ? -1 : 2),
              style: ElevatedButton.styleFrom(
                elevation: 0,
                padding: const EdgeInsets.fromLTRB(60, 15, 60, 15),
                backgroundColor: selectedIndex == 2
        ...
        Row(
          ...
          children: [
            ElevatedButton(
              onPressed: () =>
                  setState(() => selectedIndex = selectedIndex == 3 ? -1 : 3),
              style: ElevatedButton.styleFrom(
                elevation: 0,
                padding: const EdgeInsets.fromLTRB(60, 15, 60, 15),
            ...
            ElevatedButton(
              onPressed: () =>
                  setState(() => selectedIndex = selectedIndex == 4 ? -1 : 4),
              style: ElevatedButton.styleFrom(
                elevation: 0,
                padding: const EdgeInsets.fromLTRB(60, 15, 60, 15),
