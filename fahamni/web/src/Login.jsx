        ...
        <div style={styles.card}>
          ...
          <form onSubmit={handleLogin} style={styles.form}>
            ...
            <div style={styles.rememberRow}>
              <label style={styles.rememberLabel} onClick={() => setRememberMe(v => !v)}>
                <div style={{
                  ...styles.checkbox,
                  background: rememberMe ? "#000080" : "#fff",
                  borderColor: rememberMe ? "#000080" : "#c7d2fe",
                }}>
                  {rememberMe && (
          ...
          <div style={styles.cardFooter}>
            ...
            <p style={styles.secureText}>
              Secure administrative gateway for institutional partners.
            </p>
            <p style={styles.ipText}>
              IP: 127.0.0.1{" "}
      ...
      <footer style={styles.footer}>
        <div style={styles.footerLeft}>
          ...
          <span style={styles.footerCopy}>
            © 2024 Fahamni Institutional Portal. All rights reserved.
          </span>
        </div>
...
const styles = {
  ...
  card: {
    ...
    maxWidth: 420,
    padding: "28px 36px",
    boxShadow: "0 4px 32px rgba(0,0,80,0.08)",
